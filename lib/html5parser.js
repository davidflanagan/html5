...
var Tokenizer = HTML5.Tokenizer = function HTML5Tokenizer(input, document,
                                                          tokenCallback)
{
...
Tokenizer.prototype.consume_entity = function(buffer, from_attr) {
	...
	var filteredEntityList = Object.keys(HTML5.ENTITIES).filter(function(e) {
	    return e[0] == chars[0];
	});
	var entityName = null;
	while(true) {
...
var TreeBuilder = HTML5.TreeBuilder = function TreeBuilder(document) {
...
TreeBuilder.prototype.insert_text = function(data, parent) {
    if(!parent) parent = this.open_elements.last();
    if(!this.insert_from_table ||
       HTML5.TABLE_INSERT_MODE_ELEMENTS.indexOf(this.open_elements.last().tagName.toLowerCase()) == -1) {
...
// html5/parser.js
var Parser = HTML5.Parser = function Parser(options) {
    this.strict = false;
    this.errors = [];
    var phase;
