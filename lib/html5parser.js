var HTML5 = (function() {
    ...
    Tokenizer.prototype.tokenize = function() {
        try {
            console.log("tokenize", this.state);
...
*/
    ...
    */
    ...
    Parser.prototype.parse_fragment = function(source, containerTagName) {
        debug('parser.parse_fragment', source, element)
    ...
    */
    ...
    Phase.prototype = {
	    ...
	    for(var i = 0; i < attributes.length; i++) {
                ...
                if (!alreadyhas) html.attributes.push(atributes[i]);
	    }
    ...
    var PHASES =  {
        ...
        inBody: {
		    ...
		    for(var i = 0; i < attributes.length; i++) {
                        ...
                        if (!alreadyhas) {
                            body.attributes.push(atributes[i]);
                        }
		    }
	        }
            },
